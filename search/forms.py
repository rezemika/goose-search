...
class SearchForm(forms.Form):
    ...
    user_address = forms.CharField(
        label=_("Adresse estimée"),
        required=False, widget=forms.TextInput(attrs={
            "class": "form-control",
            "placeholder": _("entrer une adresse manuellement")
        })
    )
    radius = forms.IntegerField(
        label=_("Rayon de recherche"),
        help_text=_("en mètres"),
